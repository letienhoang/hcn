...
@Component({
  selector: 'app-material-category-detail',
  templateUrl: './material-category-detail.component.html',
})
export class MaterialCategoryDetailComponent implements OnInit, OnDestroy {
  ...
  selectedEntity = {} as MaterialCategoryDto;
  constructor(
    ...
    forkJoin({
      ...
      .subscribe({
        next: (response: any) => {
          ...
          var materialCategories = response.materialCategories as MaterialCategoryInListDto[];
          materialCategories.forEach(element => {
  ...
  loadFormDetails(id: string) {
    ...
    this.materialCategoryService
      ...
      .pipe(takeUntil(this.ngUnsubscribe))
      .subscribe({
        next: (response: MaterialCategoryDto) => {
  ...
  loadThumbnail(fileName: string){
    this.materialCategoryService.getThumbnailImage(fileName)
    .pipe(takeUntil(this.ngUnsubscribe))
    .subscribe({
