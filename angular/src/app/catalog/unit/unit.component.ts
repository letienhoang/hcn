...
import { UnitDto, UnitInListDto, UnitsService } from '@proxy/catalog/units';
...
export class UnitComponent implements OnInit, OnDestroy {
  ...
  items: UnitInListDto[] = [];
  public selectedItems: UnitInListDto[] = [];
  ...
  loadData() {
    ...
    this.unitService
      ...
      .subscribe({
        next: (response: PagedResultDto<UnitInListDto>) => {
  ...
  showAddModal() {
    ...
    ref.onClose.subscribe((data: UnitDto) => {
      if (data) {
        this.loadData();
